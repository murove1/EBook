          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Пункт4 <span class="caret"></span></a>
             ...
             <!-- <button type="button" class="btn btn-success">
              ...
              @else
              <li><a href="#" title="Додати книгу"><span class="glyphicon glyphicon-plus"></span></a></li>
              <li class="dropdown">
                <a href="#" class="dropdown-toggle_profile" data-toggle="dropdown" role="button" aria-expanded="false">
                <img class="user-avatar" alt="avatar" src="/img/avatar/{{ Auth::user()->avatar }}">
                  {{ Auth::user()->name }} <span class="caret"></span>
                </a>

                <ul class="dropdown-menu" role="menu">
                   <li><a href="{{ url('profile') }}"><span class="glyphicon glyphicon-user"></span> Профіль</a></li>
                    <li>
                      <a href="{{ route('logout') }}"
