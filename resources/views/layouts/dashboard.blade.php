        ...
        <ul class="user-menu">
          <li class="dropdown pull-right">
            ...
            <ul class="dropdown-menu" role="menu">
              <li><a href="{{ route('user.show', Auth::user()->id)}}"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Профіль</a></li>
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    <ul class="nav menu">
      ...
      <li class="{{ Request::is('dashboard/categories') ? "active" : "" }}"><a href="{{ url('dashboard/categories') }}"><svg class="glyph stroked tag"><use xlink:href="#stroked-tag"/></svg>
        ...
        <li class="{{ Request::is('dashboard/messages') ? "active" : "" }}"><a href="{{ url('dashboard/messages') }}"><svg class="glyph stroked open letter"><use xlink:href="#stroked-open-letter"/></svg> Повідомлення <span class="badge">66</span></a></li>
        <li role="presentation" class="divider"></li>
      </ul>
    </div><!--/.sidebar-->
